...
word_sketch.common_collocations_in_parsed_corpus("files/parsed_corpora/OANC_spoken_penn_3.1_en.p","be","have",4)

#word_sketch.search_in_parsed_corpus("files/parsed_corpora/aktualnosci_uw_IPI_PAN_1.1_pl.p", "uniwersytet", 12)
word_sketch.search_in_parsed_corpus("files/parsed_corpora/OANC_spoken_penn_3.1_en.p", "house", 12)
